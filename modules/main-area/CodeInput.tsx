...
const CodeInput = ({ code, setCode, fontSize }: CodeInputProps) => {
  ...
  return (
    <div className="h-full flex flex-col px-6 pb-4">
      ...
      <div className="relative flex-1 min-h-0 max-h-[80vh]">
        <div className="absolute inset-0 bg-gradient-to-br from-zinc-800/30 to-zinc-900/30 rounded-xl backdrop-blur-sm border border-white/10 shadow-2xl z-0" />
        <ScrollArea className="relative z-10 h-full overflow-hidden rounded-xl">
          <Editor
            value={code}
